...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_ONDEMAND_SEC
static
#endif
struct cpufreq_governor cpufreq_gov_ondemand_sec = {
       .name                   = "ondemand_sec",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_ondemand_sec);
}

static void __exit cpufreq_gov_dbs_exit(void)
{
	cpufreq_unregister_governor(&cpufreq_gov_ondemand_sec);
}
...
#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_ONDEMAND_SEC
